 ...
 */
public class ApplicationLauncherAsyncCallbackComponentMessaginTest1 extends AFXSpringXmlLauncher {
    private static final Logger log = Logger.getLogger(ApplicationLauncherAsyncCallbackComponentMessaginTest1.class
            .getName());
    ...
    private static void initStyles() {
        for (int i = 0; i < 2; i++) {
            URL res = ApplicationLauncherAsyncCallbackComponentMessaginTest1.class.getResource(BINARY_FILES[i]);
            if (res == null)
                res = ApplicationLauncherAsyncCallbackComponentMessaginTest1.class.getResource(STYLE_FILES[i]);
