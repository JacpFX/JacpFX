 ...
 */
public class ApplicationLauncherCallbackComponentMessaginTest1 extends AFXSpringXmlLauncher {
    private static final Logger log = Logger.getLogger(ApplicationLauncherCallbackComponentMessaginTest1.class
            .getName());
    ...
    public static volatile ApplicationLauncherCallbackComponentMessaginTest1[] instance = new ApplicationLauncherCallbackComponentMessaginTest1[1];

    public ApplicationLauncherCallbackComponentMessaginTest1() {
    }

    public ApplicationLauncherCallbackComponentMessaginTest1(CountDownLatch latch) {
        this.latch = latch;
    }
    ...
    private static void initStyles() {
        for (int i = 0; i < 2; i++) {
            URL res = ApplicationLauncherCallbackComponentMessaginTest1.class.getResource(BINARY_FILES[i]);
            if (res == null)
                res = ApplicationLauncherCallbackComponentMessaginTest1.class.getResource(STYLE_FILES[i]);
