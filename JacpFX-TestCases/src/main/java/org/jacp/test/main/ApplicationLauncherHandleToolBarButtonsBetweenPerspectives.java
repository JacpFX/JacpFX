...
public class ApplicationLauncherHandleToolBarButtonsBetweenPerspectives extends AFXSpringLauncher {
    ...
    public static volatile ApplicationLauncherHandleToolBarButtonsBetweenPerspectives[] instance = new ApplicationLauncherHandleToolBarButtonsBetweenPerspectives[1];
    ...
    private static void initStyles() {
        for (int i = 0; i < 2; i++) {
            URL res = ApplicationLauncherHandleToolBarButtonsBetweenPerspectives.class.getResource(BINARY_FILES[i]);
            if (res == null)
                res = ApplicationLauncherHandleToolBarButtonsBetweenPerspectives.class.getResource(STYLE_FILES[i]);
