...
public class WorkbenchHandleToolBarButtonsBetweenPerspectives implements FXWorkbench {
    ...
    private MenuItem getStyle(final int count) {
        ...
        itemHelp.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(final ActionEvent arg0) {
                final Scene scene = WorkbenchHandleToolBarButtonsBetweenPerspectives.this.stage.getScene();
    ...
    private List<MenuItem> getTestMenuItems() {
        ...
        test1.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(final ActionEvent arg0) {
                // create a modal dialog
                context.send(PerspectiveIds.PerspectiveToolbarOne, "show");
        ...
        test2.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(final ActionEvent arg0) {
                // create a modal dialog
                context.send(PerspectiveIds.PerspectiveToolbarTwo, "show");
