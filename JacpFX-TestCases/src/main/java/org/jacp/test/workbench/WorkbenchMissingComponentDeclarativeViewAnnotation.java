 ...
 */
@org.jacpfx.api.annotations.workbench.Workbench(id = "id1", name = "workbench", perspectives = {"id08"})
public class WorkbenchMissingComponentDeclarativeViewAnnotation implements FXWorkbench {
    private Stage stage;
    @Resource
    Context context;
    ...
    private MenuItem getStyle(final int count) {
        ...
        itemHelp.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(final ActionEvent arg0) {
                final Scene scene = WorkbenchMissingComponentDeclarativeViewAnnotation.this.stage.getScene();
