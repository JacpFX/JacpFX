 ...
 */
@org.jacpfx.api.annotations.workbench.Workbench(id = "id10",  perspectives = {PerspectiveIds.PerspectiveMissingIdInPerspective})
    ...
    private MenuItem getStyle(final int count) {
        ...
        itemHelp.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(final ActionEvent arg0) {
                final Scene scene = WorkbenchMissingIdInPerspective.this.stage.getScene();
