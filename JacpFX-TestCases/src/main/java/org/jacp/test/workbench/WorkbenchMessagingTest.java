...
public class WorkbenchMessagingTest implements FXWorkbench {
    ...
    public void postHandle(final FXComponentLayout layout) {
        ...
        final Menu menuTests = new Menu("Perspectives");
    ...
    private MenuItem getStyle(final int count) {
        ...
        itemHelp.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(final ActionEvent arg0) {
                final Scene scene = WorkbenchMessagingTest.this.stage.getScene();
    ...
    private List<MenuItem> getTestMenuItems() {
        ...
        final MenuItem test1 = new MenuItem("Perspective1");
        test1.setOnAction((event)->{
            context.send(PerspectiveIds.PerspectiveMessagingTest,"active");
        });
        final MenuItem test2 = new MenuItem("Perspective2");
        test2.setOnAction((event)->{
             context.send(PerspectiveIds.PerspectiveMessagingTest2,"active");
        });
        final MenuItem test3 = new MenuItem("Perspective3");
        test3.setOnAction((event)->{
             context.send(PerspectiveIds.PerspectiveMessagingTest3,"active");
        });
