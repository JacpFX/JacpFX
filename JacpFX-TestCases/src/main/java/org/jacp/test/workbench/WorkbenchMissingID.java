 ...
 */
@org.jacpfx.api.annotations.workbench.Workbench(id = "", name = "workbench", perspectives = {})
public class WorkbenchMissingID implements FXWorkbench {
    private Stage stage;
    @Resource
    JACPContext context;
    ...
    private MenuItem getStyle(final int count) {
        ...
        itemHelp.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(final ActionEvent arg0) {
                final Scene scene = WorkbenchMissingID.this.stage.getScene();
