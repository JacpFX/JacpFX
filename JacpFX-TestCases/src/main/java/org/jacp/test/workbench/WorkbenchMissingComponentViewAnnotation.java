 ...
 */
@org.jacpfx.api.annotations.workbench.Workbench(id = "id1", name = "workbench", perspectives = {"id07"})
public class WorkbenchMissingComponentViewAnnotation implements FXWorkbench {
    private Stage stage;
    @Resource
    JACPContext context;
    ...
    private MenuItem getStyle(final int count) {
        ...
        itemHelp.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(final ActionEvent arg0) {
                final Scene scene = WorkbenchMissingComponentViewAnnotation.this.stage.getScene();
