 ...
 */
@org.jacpfx.api.annotations.workbench.Workbench(id = "id1", name = "workbench", perspectives = {"id09"})
public class WorkbenchMissingComponentInitialTargetId implements FXWorkbench {
    private Stage stage;
    @Resource
    JACPContext context;
    ...
    private MenuItem getStyle(final int count) {
        ...
        itemHelp.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(final ActionEvent arg0) {
                final Scene scene = WorkbenchMissingComponentInitialTargetId.this.stage.getScene();
