 ...
 */
@org.jacpfx.api.annotations.workbench.Workbench(id = "id1", name = "workbench", perspectives = {"id17","id18"})
public class WorkbenchPredestroyPerspectiveTest implements FXWorkbench {
    ...
    public static void startPerspective() {
        context.send("id17", FXUtil.MessageUtil.INIT);
    }
