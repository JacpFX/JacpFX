 ...
 */
@Perspective(id = PerspectiveIds.PerspectiveTestSwitchA,
        components = {"id003"},
        viewLocation = "/fxml/perspectiveOne.fxml",
        resourceBundleLocation = "bundles.languageBundle",
        localeID = "en_US", active = true)
public class PerspectiveTestSwitchA implements FXPerspective {
    @FXML
    ...
    public void onStartPerspective(final FXComponentLayout layout,
        ...
        final Button p1 = new Button("Perspective B");
        p1.setOnMouseClicked((event)->context.send(PerspectiveIds.PerspectiveTestSwitchB, "show"));
