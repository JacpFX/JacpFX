...
/**
 * Test if two component instances are existing and managed dialog referencing without parent (not qualified)
 * Created by Andy Moncsek on 06.01.14.
 */
public class DialogsTwoComponentInstancesSameId {
