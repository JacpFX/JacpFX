 ...
 *
 *  [InvalidInitialisationException.java]
...
public class InvalidInitialisationException extends RuntimeException {
    ...
    public InvalidInitialisationException() {
    ...
    public InvalidInitialisationException(String message, Throwable e) {
        super(message, e);
    }

    public InvalidInitialisationException(Throwable e) {
        super(e);
    }
}
