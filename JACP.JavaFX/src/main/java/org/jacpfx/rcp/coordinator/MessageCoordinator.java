...
public class MessageCoordinator extends AFXCoordinator implements
    ...
    private void findCorrectTargetAndProceed(final String targetId,final Message<Event, Object> message) {
        ...
        if(component!=null) {
            ...
            if(parentId.equalsIgnoreCase(component.getParentId())){
                ...
                final String globalTaget = component.getParentId().concat(targetId);
                delegateMessageToCorrectPerspective(globalTaget,new FXMessage(message.getSourceId(),globalTaget,message.getMessageBody(),message.getSourceEvent()));
            }
        ...
        if(perspective!=null) {
            ...
            // TODO check if targetPerspective is active
    ...
    private void handleGlobalComponentMessage(final String targetId,final Message<Event, Object> message) {
        ...
        if(parentId.equalsIgnoreCase(parentMessageId)) {
           // this is a message to local component in current perspective
            ...
            // TODO check if targetPerspective is active
            delegateMessageToCorrectPerspective(targetId,message);
        }
    }
    ...
    private void delegateMessageToCorrectPerspective(final String targetId,final Message<Event, Object> message) {
        try {
            this.delegateQueue.put(new DelegateDTO(targetId, message));
